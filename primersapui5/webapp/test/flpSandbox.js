		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Primer SAPUI5",
									"targetURL": "#sapdemoprimersapui5primersapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapdemoprimersapui5primersapui5-display": {
								"semanticObject": "sapdemoprimersapui5primersapui5",
								"action": "display",
								"description": "A Fiori application. Sapui5 App",
								"title": "Primer SAPUI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.demo.primersapui5.primersapui5",
									"url": sap.ui.require.toUrl("sap/demo/primersapui5/primersapui5")
								}
							}
						}
					}
